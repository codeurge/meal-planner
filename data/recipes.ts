...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    instructions: [
      ...
      { step: 2, title: 'Make the roux', text: "Don't drain! Add 3 tbsp flour, stir 1 minute" },
  ...
  },
  {
    ...
    instructions: [
      ...
      { step: 3, text: 'Pour in eggs, gently push with spatula as they set' },
  ...
  // LUNCH
  {
    ...
    instructions: [
      ...
      { step: 7, text: 'Fold: bottom up, sides in, roll tight' },
  ...
  // DINNERS
  {
    ...
    instructions: [
      ...
      { step: 3, title: 'Simmer covered', text: "Reduce heat to low. Cover with tight-fitting lid. Don't peek! Rice needs steam. (18-20 min)" },
  ...
  },
  {
    ...
    instructions: [
      ...
      { step: 3, title: 'Smash the potatoes', text: 'Add butter, sour cream, parmesan to pot. Smash with fork or masher (leave chunky!). Season with salt & pepper. Cover to keep warm.' },
      { step: 4, title: 'Cook steak', text: 'Heat cast iron or heavy skillet over high heat (get it HOT). Add 1 tbsp oil. Sear steaks 4-5 min per side for medium. Rest 5 minutes before slicing. (8-12 min)' },
